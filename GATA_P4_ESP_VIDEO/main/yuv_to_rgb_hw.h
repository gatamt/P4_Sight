 ...
 *
 *   Even rows: U Y Y U Y Y U Y Y ...   (3 bytes per 2 pixels)
 *   Odd  rows: V Y Y V Y Y V Y Y ...
 *   Stride = width × 3/2              (1920 bytes for 1280 wide)
 *
 * This module decodes the format with full-range BT.601 coefficients and
 * combines conversion and decimation in a single pass.
 */
#pragma once
