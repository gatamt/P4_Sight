...
static const bf3925_reginfo_t DVP_8bit_20Minput_1600x1200_yuv422_9fps[] = {
    ...
    //clock，dummy
    {0xff, 0x01},  //Bit[0]: select reg page
    {0xe9, 0x2a},  //PLL multipliers: 0x09=1x, 0x1b=1.25x, 0x2b=1.5x, 0x08=2x, 0x1a=2.5x, 0x2a=3x
    ...
    */
    ...
    {0x93, 0x0a},  //Lower 0x93[4:0] reduces noise but softens edges; tested value 0x0c
    ...
    {0x86, 0xfa},
    {0x87, 0x1a},
    {0x88, 0xa2},  //Set bits 7 and 6 to zero for lower noise
    {0x89, 0xca},
    {0x8b, 0x12}, //0x8b[7:4]: Bright edge enhancement; 0x8b[3:0]: Dark edge enhancement
    {0x91, 0x45},  //Writing 0x40 to register 0x91 increases sharpness and noise
    ...
    {0xa7, 0x1b},  //Base blue gain; modification is not recommended
    {0xa8, 0x14},  //Base red gain; modification is not recommended
    {0xa9, 0x15},
    {0xaa, 0x18},
    {0xab, 0x26},
    {0xac, 0x5c},
    ...
    {0xff, 0x01}, //Bit[0]: select reg page
    {0x00, 0x05},
    {0x01, 0x8a}, // AE windows and weights
    {0x04, 0x45}, // AE Target
    ...
    // auto contrast
    {0xff, 0x01}, //Bit[0]: select reg page
    {0x3e, 0x02}, //Adjustment is not recommended
};
