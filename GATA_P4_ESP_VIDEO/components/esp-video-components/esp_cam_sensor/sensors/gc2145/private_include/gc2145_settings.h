...
static const gc2145_reginfo_t gc2145_mipi_1lane_24Minput_640x480_rgb565_15fps[] = {
    {0xfe, 0xf0},
    {0xfe, 0xf0},
    {0xfe, 0xf0},
    {0xfc, 0x06},
...
static const gc2145_reginfo_t gc2145_DVP_8bit_20Minput_640x480_rgb565_15fps_windowing[] = {
    ...
    {0x12, 0x2e}, //YUV output is invalid when sh_delay is too short
    ...
    {0x1c, 0x07}, //At higher frame rates, 0x06 can produce horizontal banding //12 //TX Width,Space Width
    {0x1d, 0x10}, //double reset
    {0x1e, 0x88},//0x90/0x98 fixes vertical lines//Analog Mode1,TX high,Coln_r
    {0x1f, 0x78}, //78 //38 //18 //Analog Mode2,txlow
    {0x20, 0x03}, //07 //Analog Mode3,comv,ad_clk mode
    {0x21, 0x40},//0x10/0x20/0x40 fixes fluorescent-light horizontal banding
    {0x22, 0xa0},//0xd0/0xf0/0xa2 Vref/vpix; severe fixed-pattern noise
    {0x24, 0x1e},
    {0x25, 0x01}, //col sel
    {0x26, 0x10}, //Analog PGA gain1
    {0x2d, 0x60},//40//40 //txl drv mode
    {0x30, 0x01}, //Analog Mode4
    {0x31, 0x90},//0xb0/0x70; analog mode 7, bits [7:5] control rsgh_r banding, bits [4:3] control isp_g
    ...
    {GC2145_REG_P0_OUTPUT_FORMAT, 0x06}, //output format [4:0] output data mode 5’h06 RGB 565
    ...
    {0x21, 0x14}, //luma_value_div_sel divider; incrementing this value halves register 0xef
...
static const gc2145_reginfo_t gc2145_DVP_8bit_20Minput_1600x1200_rgb565_13fps[] = {
    {0xfe, 0xf0},
    {GC2145_REG_DELAY, 0x09},
    {0xfc, 0x06},
    {0xf6, 0x00},
...
static const gc2145_reginfo_t gc2145_DVP_8bit_20Minput_800x600_rgb565_20fps[] = {
    {0xfe, 0xf0},
    {GC2145_REG_DELAY, 0x09},
    {0xfc, 0x06},
    {0xf6, 0x00},
